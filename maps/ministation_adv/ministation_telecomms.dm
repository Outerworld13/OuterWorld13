/obj/machinery/telecomms/bus/preset_one/ministation_adv
	id = "Bus"
	network = "tcommsat"
	freq_listening = list()
	autolinkers = list("processor1","server1","hub")

/obj/machinery/telecomms/processor/preset_one/ministation_adv
	id = "Processor"
	network = "tcommsat"
	autolinkers = list("processor1","hub")

/obj/machinery/telecomms/server/presets/ministation_adv
	id = "Server"
	freq_listening = list()
	channel_tags = list(
...
/obj/machinery/telecomms/hub/preset/ministation_adv
	id = "Hub"
	network = "tcommsat"
